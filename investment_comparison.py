...
@st.cache_data
def fetch_data():
    # Fetch historical data for S&P 500 ETF (VOO), VWO ETF, US T-Bonds ETF (IEF), and CAD-USD exchange rate
    ...
    return s_p500_etf, vwo_etf, t_bonds_etf, cad_usd

# Load data
s_p500_etf, vwo_etf, t_bonds_etf, cad_usd = fetch_data()
...
# Asset selection
asset_options = ['S&P 500 Index (VOO)', 'Emerging Market Index (VWO)', '60:40 Split (S&P 500:US T-Bonds)']
